...
<div class="modal" id="modal" data-cc-toggle-cascade="#overlay" data-cc-toggle-trigger-on="direct-only" data-cc-toggle-action="deactivate" data-cc-target="modal">
    <div class="modal__dialog">

        <div id="modal-tab-1" data-cc-toggle-cascade="#modal" data-cc-toggle-group="modal-tabs" class="u-toggle">
            <div class="card">
                <div class="card__header">
                    <h2>Modal Content 1</h2>
                </div>
                <div class="u-block">
                    <p><a href="#" class="js-cc-toggle" data-cc-toggle-action="activate" data-cc-toggle-target="#modal-tab-2">Show Modal 2 Content</a></p>
        ...
        <div id="modal-tab-2" data-cc-toggle-cascade="modal" data-cc-toggle-group="modal-tabs" class="u-toggle">
            <div class="card">
                <div class="card__header">
                    <h2>Modal Content 2</h2>
                </div>
                <div class="u-block">
                    <p><a href="#" class="js-cc-toggle" data-cc-toggle-action="activate" data-cc-toggle-target="#modal-tab-1">Show Modal 1 Content</a></p>
