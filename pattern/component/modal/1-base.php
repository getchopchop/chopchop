...
Title: Modal
Class: .modal
Description: The modal is hidden off screen by default. <a href="#" class="js-cc-toggle" data-cc-toggle-action="activate" data-cc-toggle-target="#modal-tab-1">Show modal 1 content</a> or <a href="#" class="js-cc-toggle" data-cc-toggle-action="activate" data-cc-toggle-target="#modal-tab-2">Show modal 2 content</a>.
*/ ?>

<div class="modal" id="modal" data-cc-toggle-cascade="#overlay" data-cc-toggle-trigger-type="direct-only" data-cc-toggle-action="deactivate" data-cc-toggle-target="modal">
    <div class="modal__dialog">

        <div id="modal-tab-1" data-cc-toggle-cascade="#modal" data-cc-toggle-target=".js-modal-content-1" data-cc-toggle-target-callback="#modal-tab-1 .close" data-cc-toggle-group="modal-tabs" class="u-toggle">
            <div class="card">
                <div class="card__header">
                    <h2>Modal Content 1</h2>
                </div>
                <div class="u-block">
                    <p><a href="#" class="js-cc-toggle js-modal-content-2" data-cc-toggle-action="activate" data-cc-toggle-target="#modal-tab-2">Show Modal 2 Content</a></p>
                ...
                <div class="card__footer">
                    <a href="#" class="close" data-cc-toggle-stateful="false" data-cc-toggle-action="deactivate" data-cc-toggle-target="#modal">Close</a>
                </div>
            </div>
        </div>

        <div id="modal-tab-2" data-cc-toggle-cascade="#modal" data-cc-toggle-target=".js-modal-content-2" data-cc-toggle-target-callback="#modal-tab-2 .close" data-cc-toggle-group="modal-tabs" class="u-toggle">
            <div class="card">
                <div class="card__header">
                    <h2>Modal Content 2</h2>
                </div>
                <div class="u-block">
                    <p><a href="#" class="js-cc-toggle js-modal-content-1" data-cc-toggle-action="activate" data-cc-toggle-target="#modal-tab-1">Show Modal 1 Content</a></p>
