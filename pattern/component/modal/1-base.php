...
<div class="modal" id="modal" data-cc-toggle-cascade="#overlay, .modal-tab" data-cc-toggle-trigger-type="direct-only" data-cc-toggle-action="deactivate" data-cc-toggle-target="modal">
    <div class="modal__dialog">
        ...
        <div id="modal-tab-1" data-cc-toggle-cascade="#modal"  data-cc-toggle-target-callback="#modal-tab-1 .close, .js-modal-content-1" data-cc-toggle-group="modal-tabs" class="u-toggle modal-tab">
            <div class="card">
        ...
        <div id="modal-tab-2" data-cc-toggle-cascade="#modal" data-cc-toggle-target=".js-modal-content-2" data-cc-toggle-target-callback="#modal-tab-2 .close, .js-modal-content-2" data-cc-toggle-group="modal-tabs" class="u-toggle modal-tab">
            <div class="card">
                <div class="card__header">
