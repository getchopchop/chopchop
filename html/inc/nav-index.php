<div class="cc-index-nav">
    ...
    ?>
    <div>
        <div class="nav-<?= $toplevel ?> cc-index-nav__item">
            ...
            <div class="cc-index-nav__body u-toggle" id="toggle-<?= $toplevel ?>" data-cc-cascade="toggle-title-<?= $toplevel ?>" data-cc-group="toggle-contents">
