<div class="is-active">
    ...
    <div id="myModal" class="modal modal--lg">
        ...
        <a href="#" class="btn btn--sm btn--blue btn--square modal__close">
            <span class="icon-rw-close"></i>
        ...
        <div class="modal__dialog">
            ...
            <div class="modal__header">
                <h3 class="modal__title">This is a modal, plain and simple.</h3>
            </div>
            ...
            <div class="modal__footer">
                <a href="#" class="btn btn--sm btn--blue">
                    <span class="icon-cancel"></i>
                    <span class="btn__text">Close Me</span>
                </a>
            </div>
