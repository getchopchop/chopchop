...
;(function($){
    ...
    $.widget(Static.WIDGET_ID, $.chopchop.base, {
        ...
        _getTargets: function(){
            return $(this._getLocalOption(this.options.dataTarget), this._getClosestContainer()).add(this.$targetElements);
        },

        _getTargetCallbackElements: function(){
            return $(this._getLocalOption(this.options.dataTargetCallback), this._getClosestContainer()).add(this.$targetCallbackElements);
        },

        _getGroupItems: function(){
            if(!this._getLocalOption(this.options.dataGroup)){
                return this.$groupElements;
            }

            return $(this._getGlobalDataSelector(this.options.dataGroup, this._getLocalOption(this.options.dataGroup)), this._getClosestContainer()).add(this.$groupElements);
        },
